      ...
      <div ref={triggerRef}>
        <div className="h-screen w-400vw flex flex-row relative" ref={sectionRef}>
          ...
          <div className="h-screen w-screen flex flex-col justify-center items-center">
            ...
            <div className="p-8 text-md md:text-lg lg:text-xl font-dm text-center text-gray-600 leading-relaxed space-y-6">
              <p>
                <strong>
                  <span className="text-blue-700">ztl.me</span>{" "}
                </strong>{" "}
                starter reisen med å utfordre forsikringsmarkedet med et solid fundament på{" "}
                <strong>
                  <span className="text-blue-700">40 000 selvforsikrere</span>{" "}
                </strong>
                .
              </p>
              <p>
                <strong>
                  <span className="text-blue-700">Hvorfor akkurat 40 000 selvforsikrere?</span>{" "}
                </strong>{" "}
                Hvis man tar utgangspunkt i en gjennomsnittlig forsikringskunde i Norge sier matematiske forsikringsmodeller at man trenger{" "}
                <strong>
                  <span className="text-blue-700">33 000 kunder</span>{" "}
                </strong>{" "}
                for å kunne drive lønnsom forsikringsvirksomhet.
              </p>
              <p>
                Dette inkluderer alle utbetalinger til skade og tap, samt drift og avkastning på egenkapitalen. Vi har derfor lagt oss på et litt høyere nivå
                slik at{" "}
                <strong>
                  <span className="text-blue-700">ztl.me</span>{" "}
                </strong>{" "}
                har en ekstra god margin, noe som uansett kommer{" "}
                <strong>
                  <span className="text-blue-700">ztl.mes selvforsikrere</span>{" "}
                </strong>{" "}
                til gode i form av avkastning. Ytterligere til gode.
              </p>
            </div>
          </div>
          {/* Feature 2 */}
...
const content = [
  {
    ...
    content: (
      <div className="h-full w-full bg-[linear-gradient(to_bottom_right,var(--cyan-500),var(--emerald-500))] flex items-center justify-center text-white">
        <Image src="/body_1.png" width={300} height={300} className="h-full w-full object-cover" alt="linear board demo" />
      </div>
    ),
  },
  {
    ...
    content: (
      <div className="h-full w-full  flex items-center justify-center text-white">
        <Image src="/body_2.png" width={300} height={300} className="h-full w-full object-cover" alt="linear board demo" />
      </div>
    ),
  },
  {
    ...
    content: (
      <div className="h-full w-full  flex items-center justify-center text-white">
        <Image src="/body_3.png" width={300} height={300} className="h-full w-full object-cover" alt="linear board demo" />
      </div>
    ),
  },
  {
    ...
    <div className="flex flex-col md:flex-row bg-white-100 p-4">
      {reversedOrder ? (
        <div className="flex flex-col p-4 rounded-lg justify-center md:w-1/2 md:mr-8 md:order-2">
          ...
          <Button variant="default" className="mt-4 mx-auto bg-blue-600" onClick={() => setFirstFeatureOpened(!featureOpened)}>
